...
// in simulator we redefine to format for rss004 Developer console
...
{\
	NSString * exceptionName = [@"org.rss004." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.rss004";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIrss004NativeItemNone = -1, 
	UIrss004NativeItemSpinner = -2,
	UIrss004NativeItemProgressBar = -3,
	
	UIrss004NativeItemSlider = -4,
	UIrss004NativeItemSwitch = -5,
	UIrss004NativeItemMultiButton = -6,
	UIrss004NativeItemSegmented = -7,
	
	UIrss004NativeItemTextView = -8,
	UIrss004NativeItemTextField = -9,
	UIrss004NativeItemSearchBar = -10,
	
	UIrss004NativeItemPicker = -11,
	UIrss004NativeItemDatePicker = -12,
	
	UIrss004NativeItemInfoLight = -13,
	UIrss004NativeItemInfoDark = -14,
	
	UIrss004NativeItemDisclosure = -15,
	
	UIrss004NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all rss004 instances of

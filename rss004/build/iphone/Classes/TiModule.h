...
/**
 The base class for all rss004 modules
 */
...
/**
 rss004 Platform calls this method on startup.
 */
-(void)startup;

/**
 rss004 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 rss004 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 rss004 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 rss004 Platform calls this method on resume.
 @param sender The sender of the event.
 */

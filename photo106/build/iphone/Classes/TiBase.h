...
// in simulator we redefine to format for photo106 Developer console
...
{\
	NSString * exceptionName = [@"org.photo106." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.photo106";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIphoto106NativeItemNone = -1, 
	UIphoto106NativeItemSpinner = -2,
	UIphoto106NativeItemProgressBar = -3,
	
	UIphoto106NativeItemSlider = -4,
	UIphoto106NativeItemSwitch = -5,
	UIphoto106NativeItemMultiButton = -6,
	UIphoto106NativeItemSegmented = -7,
	
	UIphoto106NativeItemTextView = -8,
	UIphoto106NativeItemTextField = -9,
	UIphoto106NativeItemSearchBar = -10,
	
	UIphoto106NativeItemPicker = -11,
	UIphoto106NativeItemDatePicker = -12,
	
	UIphoto106NativeItemInfoLight = -13,
	UIphoto106NativeItemInfoDark = -14,
	
	UIphoto106NativeItemDisclosure = -15,
	
	UIphoto106NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all photo106 instances of

...
//@interface photo106Object : NSObject
//@end

@interface photo106Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[photo106Object class]])
		{
			for (NSString *key in [[(photo106Object*)o modules] allKeys])
			{

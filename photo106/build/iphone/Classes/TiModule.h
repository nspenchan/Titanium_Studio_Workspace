...
/**
 The base class for all photo106 modules
 */
...
/**
 photo106 Platform calls this method on startup.
 */
-(void)startup;

/**
 photo106 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 photo106 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 photo106 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 photo106 Platform calls this method on resume.
 @param sender The sender of the event.
 */

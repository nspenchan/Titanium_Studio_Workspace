...
//Rare exceptions to indicate a bug in the _photo106 code (Eg, method that a subclass should have implemented)
...
+ (id)createProxy:(NSString*)qualifiedName withProperties:(NSDictionary*)properties inContext:(id<TiEvaluator>)context
{
	...
	if (proxyClass == nil) {
		NSString *_photo106 = [NSString stringWithFormat:@"%@%s",@"Ti","tanium."];
		if ([qualifiedName hasPrefix:_photo106]) {
		...
		if (proxyClass==nil) {
			...
			@throw [NSException exceptionWithName:@"org.photo106.module"

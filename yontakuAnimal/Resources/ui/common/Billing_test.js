...
function Billing(win, purchase, label_pro) {
	...
	*/
	...
	self.add(checkBillingSupportedButton);
	self.add(checkSubscriptionsSupportedButton);
	self.add(restoreTransactionsButton);
	self.add(buyButton);
	self.add(picker);
	self.add(addPayloadButton);

...
function About(win) {
	...
	if(Ti.Platform.locale=='ja'){
		var text =' ■ アプリ名：ならべる　どうぶつ\n ■ バージョン情報：ver.1.1.0\n ■ リリース：2014/1\n ■ 開発：YUKIKO NAGAOKA';
	}else{
		var text = ' ■ Application Name : Naraberu Animal\n ■ Version Information : ver.1.0.2\n ■ Released: 2014 / 1\n ■ Development : YUKIKO NAGAOKA';
	}
	...
	if(osname == 'android'){
		imageView.image = '/assets/images/naraberuanimal/about.png';
		imageView.width = width;
		imageView.height = height;
		imageView.left = -left;
	}else if(osname == 'ipad'){
		imageView.image = '/assets/images/naraberuanimal/about_ipad.png';

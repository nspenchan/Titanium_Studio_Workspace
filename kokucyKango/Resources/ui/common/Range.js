function Range(win, title, bgColor, label01) {
	var top = 0;
	...
	var back, buttonWidth, children, label, leftImage, max, min, row, 
		rows, section, self, tableview, view;
